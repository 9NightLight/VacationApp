                        ...
                        <div className='relative w-full h-full mt-12'>
                            <form onSubmit={completeSignIn} autoComplete="on">
                                <div className="absolute w-full h-full flex flex-col justify-start items-start mb-2">
                                    <label className='font-helvetica text-gray-500 text-xs'>First name</label>
                                    ...
                                    <label className='font-helvetica text-gray-500 text-xs mt-7'>Last name</label>
                                    ...
                                    <label className='font-helvetica text-gray-500 text-xs mt-7'>Coutry</label>
                                    ...
                                    <div className=" w-full mt-9 flex flex-col justify-center items-end">
                                        <button type='submit' className="w-20 h-8 bg-blue-600 text-white font-helvetica text-xs font-bold rounded-3xl">Done</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                                ...
                                <div className='relative w-full h-fit mt-12'>
                                    <form onSubmit={trySignIn} autoComplete="on">
                                        <div className="absolute w-full flex flex-col justify-start items-start mb-2">
                                            <label className=' font-helvetica text-gray-500 text-xs'>Email address</label>
                                        ...
                                        <div className="w-full h-56 flex flex-col justify-center items-end">
                                            <button type='submit' className="w-20 h-8 bg-blue-600 text-white font-helvetica text-xs font-bold rounded-3xl">Continue</button>
                                        </div>
                                    </form>
                                </div>
                            </React.Fragment>
                            ...
                            <React.Fragment>
                                ...
                                <div className='relative w-full h-fit mt-12'>
                                    <div className="absolute w-full h-40 flex flex-col justify-between items-center mb-2">
                                        ...
                                        <button onClick={() => sendVerificationEmail()} className="w-28 h-8 bg-blue-600 text-white font-helvetica text-xs font-bold rounded-3xl">Resend email</button>
                                    </div>
                                </div> 
                            </React.Fragment>
