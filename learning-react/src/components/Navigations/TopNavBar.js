...
function TopNavBar() {
    ...
    return (
        <div className="w-full h-12 border-b-2 sm:text-sm lg:text-base">
            <div className="relative w-max--75 h-full lg:left-12 sm:left-0 flex justify-between items-center ">
